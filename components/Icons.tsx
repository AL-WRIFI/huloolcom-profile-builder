...
export const EducatorsIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const BidsIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M14.5 10c-.83 0-1.5-.67-1.5-1.5v-5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5v5c0 .83-.67 1.5-1.5 1.5z"></path>
    <path d="M20.5 10H19V8.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z"></path>
    <path d="M9.5 14c-1.66 0-3-1.34-3-3v-1c0-1.66 1.34-3 3-3s3 1.34 3 3v1c0 1.66-1.34 3-3 3z"></path>
    <path d="M16 14H3c-.55 0-1 .45-1 1v5c0 .55.45 1 1 1h13c.55 0 1-.45 1-1v-5c0-.55-.45-1-1-1z"></path>
  </svg>
);
...
export const AcademicCapIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M21.79 8.35a2.2 2.2 0 0 0-2.2-2.2h-15a2.2 2.2 0 0 0-2.2 2.2V11c0 2.8 4.48 5 10 5s10-2.2 10-5Z"/>
        <path d="M3.6 8.35v3.9c0 2.48 4.03 4.5 9 4.5s9-2.02 9-4.5v-3.9"/>
        <path d="M12 18.8V22"/>
        <path d="M18 22h-12"/>
    </svg>
);
...
export const LightBulbIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M12 2a7 7 0 0 0-5.66 11.52 3.49 3.49 0 0 1-.34 4.48 2 2 0 0 0 2.83 2.83 3.49 3.49 0 0 1 4.48-.34A7 7 0 0 0 12 2z" />
    </svg>
);
...
export const ReceiptPercentIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M22 13V4a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h9" />
    <path d="m11 10.5 2.5-2.5" />
    <path d="m16 8.5 2.5-2.5" />
    <circle cx="8" cy="14.5" r=".5" fill="currentColor" />
    <circle cx="13.5" cy="9" r=".5" fill="currentColor" />
    <path d="M15.5 22a2.5 2.5 0 0 0 2.5-2.5V17a2.5 2.5 0 0 0-5 0v2.5a2.5 2.5 0 0 0 2.5 2.5Z" />
    <path d="M18.5 14.5a2.5 2.5 0 0 0-2.5 2.5V17a2.5 2.5 0 0 0 5 0v-.5a2.5 2.5 0 0 0-2.5-2.5Z" />
  </svg>
);
...
export const DocumentTextIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M17 17h2a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h2" />
    <path d="M17 9h-2.5a1.5 1.5 0 0 0 0 3h1a1.5 1.5 0 0 1 0 3H12" />
    <path d="M12 19v-3.5a1.5 1.5 0 0 1 1.5-1.5h1a1.5 1.5 0 0 1 1.5 1.5V19" />
    <path d="M12 14h.01" />
  </svg>
);
...
export const PencilSquareIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M21.731 2.269a2.625 2.625 0 00-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 000-3.712zM19.513 8.199l-3.712-3.712-8.4 8.4a5.25 5.25 0 00-1.48 3.713V19.5h3.712a5.25 5.25 0 003.713-1.48l8.4-8.4z" />
...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.898 20.624l-.259 1.035-1.035-.259a3.375 3.375 0 00-2.456-2.456L12 18.75l.259-1.035a3.375 3.375 0 002.456-2.456l1.035.259-.259 1.035a3.375 3.375 0 002.456 2.456l1.035-.259-1.035.259a3.375 3.375 0 002.456 2.456l.259 1.035-1.035-.259a3.375 3.375 0 00-2.456-2.456z" />
    </svg>
);
...
export const GlobeAltIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.231-12.231 9.004 9.004 0 00-16.462 0A9.004 9.004 0 0012 21zm0 0a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);
...
export const ClipboardDocumentCheckIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.125 2.25h-4.5c-1.125 0-2.063.938-2.063 2.063v15.375c0 1.125.938 2.063 2.063 2.063h10.5c1.125 0 2.063-.938 2.063-2.063V12.125c0-.621-.246-1.223-.684-1.662l-3-3.375c-.438-.438-1.04-.684-1.662-.684h-1.5m-3.375 9.75L9 15l-1.125-1.125" />
    </svg>
);
...
export const MenuAlt4Icon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
